...
- 为右键菜单、字数统计、拼写检查菜单增加动画并替换为模糊背景

- 为界面左边的文件树和大纲条目增加了 hover 动画

- 对未保存提示框样式进行了修改，增加了红色边框和红色主色调按钮，使其更符合主题

- 修复了原主题中，顶部搜索栏内容显示偏移的BUG，并将搜索栏输入框的焦点颜色改为主色调红色
